<div>
    ...
    @if ($isCurrantUser && Auth::user()->can("offer-create"))
        @include('user::website.offer.components.create_offer')
        @include('user::website.offer.modals.offer-modal')
    @endif
                ...
                <div class="user-post">
                    <div class="friend-info">
                        ...
                        <div class="friend-name">
                            ...
                            @if ($isCurrantUser && (Auth::user()->can('offer-edit') || Auth::user()->can('offer-delete')))
                            <div class="more">
