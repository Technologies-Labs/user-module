...
use Modules\User\Http\Controllers\UserCompanyController;
use Modules\User\Http\Controllers\UserController;
use Modules\User\Http\Controllers\UserOfferController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('notifications-templates', function(){
        return view('user::dashboard.notificationsTemplate.index');
