...
use Modules\User\Services\CompanyCustomerSayService;
use Modules\User\Services\CompanyServiceService;
use Modules\User\Services\CompanyStatisticService;
...
class CompanyCustomerSay extends Component
{
    ...
    {
        return view('user::livewire.company.company-customer-say');
    }
